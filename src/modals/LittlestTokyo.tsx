...
Command: npx gltfjsx@6.2.13 LittlestTokyo.glb 
...
export default function LittlestTokyoModel(props:any) {
  const group = useRef()
  const { nodes, materials, animations }:any = useGLTF('/modal/LittlestTokyo.glb')
...
useGLTF.preload('modal/LittlestTokyo.glb')
